defmodule Strava.Paginator do
  ...
  @spec stream((Strava.Pagination.t() -> list), pos_integer, pos_integer, non_neg_integer) ::
          Enum.t()
  def stream(
        request,
        per_page \\ Strava.max_page_size(),
        first_page \\ 1,
        delay_between_requests_in_milliseconds \\ Strava.delay_between_requests_in_milliseconds()
      )
    ...
    Stream.resource(
      fn ->
        %Strava.Paginator{
          per_page: per_page,
          page: first_page,
          request_delay: delay_between_requests_in_milliseconds
        }
      end,
  ...
  defp sleep_between_requests(%Strava.Paginator{
         request_delay: delay_between_requests_in_milliseconds
       }) do
